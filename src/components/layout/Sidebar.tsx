...
const navItems = [
  ...
  { to: '/objectives', label: 'Objectives', icon: ObjectivesIcon },
  { to: '/flashcards', label: 'Flashcards', icon: FlashcardsIcon },
  { to: '/quiz', label: 'Quiz', icon: QuizIcon },
  { to: '/exam', label: 'Practice Exam', icon: ExamIcon },
  { to: '/glossary', label: 'Glossary', icon: GlossaryIcon },
  { to: '/notes', label: 'Study Notes', icon: NotesIcon },
];
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 w-64 bg-gray-900 border-r border-gray-700 flex flex-col transition-transform duration-200 ${
      ...
      >
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-gray-100">A+ Study</span>
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-gray-700">
          <p className="text-xs text-gray-500">CompTIA A+ 220-1201 / 1202</p>
        </div>
      </aside>
    </>
  );
